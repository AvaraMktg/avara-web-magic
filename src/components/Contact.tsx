        ...
        <div className="grid grid-cols-1 gap-12 items-center">
          <div className="glass-panel rounded-2xl p-10 max-w-3xl mx-auto w-full opacity-0 animate-scale-in shadow-lg bg-white border border-gray-200" 
            ...
            <div className="text-center mb-8">
              <h4 className="text-2xl font-bold mb-4 text-black">Connect With Us</h4>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
              <div>
                <h4 className="text-xl font-bold mb-4 text-black">Why Choose Avara Marketing?</h4>
              ...
              <div>
                <h4 className="text-xl font-bold mb-4 text-black">Our Approach</h4>
                <p className="text-muted-foreground leading-relaxed">
            ...
            <div className="mt-10">
              <div className="flex flex-col space-y-6">
                <a href="mailto:avaramarketing@yahoo.com" 
                   className="flex items-center text-xl hover:text-black transition-colors group">
                  <div className="w-12 h-12 rounded-full bg-black/10 flex items-center justify-center mr-4 group-hover:bg-black/20 transition-colors">
                  ...
                  <span className="text-muted-foreground group-hover:text-black">avaramarketing@yahoo.com</span>
                </a>
                ...
                <a href="tel:+11234567890" 
                  ...
                  <span className="text-muted-foreground group-hover:text-black">+1 (123) 456-7890</span>
                </a>
                
                <div className="flex items-center text-xl group">
                  <div className="w-12 h-12 rounded-full bg-black/10 flex items-center justify-center mr-4">
                    <svg className="w-6 h-6 text-black" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="https://www.instagram.com/avara.marketing/" 
                  ...
                  <span className="text-muted-foreground group-hover:text-black">@avara.marketing</span>
                </a>
              </div>
            </div>
          </div>
