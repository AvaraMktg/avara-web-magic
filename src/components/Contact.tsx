    ...
    <section id="contact" className="py-20 px-4 relative">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 gap-12 items-center">
          <div className="glass-panel rounded-2xl p-10 max-w-3xl mx-auto w-full opacity-0 animate-scale-in" 
               style={{ animationDelay: '0.4s', animationFillMode: 'forwards' }}>
            
            <div className="text-center mb-8">
              <h4 className="text-2xl font-bold mb-4 text-avara-accent">Connect With Us</h4>
            ...
            <div className="mt-10">
              <div className="flex flex-col space-y-6">
                <a href="mailto:avaramarketing@yahoo.com" 
                  ...
                  <div className="w-12 h-12 rounded-full bg-avara-accent/10 flex items-center justify-center mr-4 group-hover:bg-avara-accent/20 transition-colors">
                    <svg className="w-6 h-6 text-avara-accent" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="tel:+11234567890" 
                  ...
                  <span className="text-muted-foreground group-hover:text-white">+1 (123) 456-7890</span>
                </a>
                
                <div className="flex items-center text-xl group">
                  <div className="w-12 h-12 rounded-full bg-avara-accent/10 flex items-center justify-center mr-4">
                    <svg className="w-6 h-6 text-avara-accent" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="https://www.instagram.com/avara.marketing/" 
                   ...
                   className="flex items-center text-xl hover:text-white transition-colors group">
                  <div className="w-12 h-12 rounded-full bg-avara-accent/10 flex items-center justify-center mr-4 group-hover:bg-avara-accent/20 transition-colors">
                    <Instagram className="w-6 h-6 text-avara-accent" />
                  </div>
