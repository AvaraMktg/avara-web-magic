  ...
  return (
    ...
    >
      <ScrollReveal 
        ...
        delay={index * 100}
        threshold={0.2}
        className="bg-black p-6 rounded-xl border border-white/20 hover:border-white/40 transition-all duration-300 service-card group-hover:service-shake shadow-sm"
      >
        <motion.div 
