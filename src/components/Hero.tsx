  ...
  return (
    <section id="home" className="min-h-screen flex flex-col items-center justify-center relative pt-20 pb-10 px-4 overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        <h2 
          className="uppercase text-avara-accent text-sm md:text-base font-medium tracking-wider mb-4 opacity-0 animate-slide-down"
        ...
        >
          <a 
            href="#projects" 
            className="bg-avara-accent text-avara-black font-medium py-3 px-8 rounded-full hover:bg-opacity-80 transition-all duration-300 transform hover:scale-105"
          >
            View Our Work
          </a>
          <a 
            href="#contact" 
            className="bg-transparent border border-white/20 text-white hover:bg-white/10 font-medium py-3 px-8 rounded-full transition-all duration-300"
          >
            Get In Touch
          </a>
        </div>
